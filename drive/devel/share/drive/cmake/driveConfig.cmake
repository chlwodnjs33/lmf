...
if("TRUE" STREQUAL "TRUE")
  set(drive_SOURCE_PREFIX /home/wego/Desktop/drive/src/drive)
  set(drive_DEVEL_PREFIX /home/wego/Desktop/drive/devel)
  set(drive_INSTALL_PREFIX "")
  set(drive_PREFIX ${drive_DEVEL_PREFIX})
else()
  set(drive_SOURCE_PREFIX "")
  set(drive_DEVEL_PREFIX "")
  set(drive_INSTALL_PREFIX /home/wego/Desktop/drive/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'drive' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wego/Desktop/drive/src/drive/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT drive_NUM_DUMMY_TARGETS)
      set(drive_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::drive::wrapped-linker-option${drive_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR drive_NUM_DUMMY_TARGETS "${drive_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::drive::wrapped-linker-option${drive_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND drive_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/wego/Desktop/drive/devel/lib;/opt/ros/melodic/lib)
